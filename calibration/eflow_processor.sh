...
python3 ../ecalphisym/calibration/eflow_processor.py --dbname ecal_prompt_v2 --campaign prompt --eras Run2024B -w ../ecalphisym/calibration/weight.txt -o ../eflow_pro_out --savePlots --verbosity 2
